...
public class FarAuto extends OpMode {
    ...
    private double flywheelTargetVelocity = 1570;
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Pose shootPose = new Pose(3.22, 3.44, Math.toRadians(28));
            Pose adjustedShootPose = new Pose(3.22, 3.44, Math.toRadians(25));

            Pose collect1StartPose = new Pose(18, 14, Math.toRadians(90));
            Pose collect1EndPose = new Pose(18, 36, Math.toRadians(90));

            Pose collect2StartPose = new Pose(40, 14, Math.toRadians(90));
            Pose collect2EndPose = new Pose(40, 36, Math.toRadians(90));

            Pose collect3StartPose = new Pose(65, 14, Math.toRadians(90));
            Pose collect3EndPose = new Pose(65, 36, Math.toRadians(90));

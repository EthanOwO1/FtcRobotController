...
public class CloseRedAuto extends OpMode {
    ...
    private double flywheelTargetVelocity = 1300;
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            // Poses
            Pose shootPose = new Pose(-39.5, 5, Math.toRadians(-4));

            Pose collect1Start = new Pose(-38.5, -22, Math.toRadians(-37.5));
            Pose collect1End = new Pose(-22.3, -34.6, Math.toRadians(-37.5));

            Pose collect2Start = new Pose(-53.8, -41, Math.toRadians(-37.5));
            Pose collect2Mid = new Pose(-42.8, -50, Math.toRadians(-37.5));
            Pose collect2End = new Pose(-26.8, -49, Math.toRadians(-37.5));

            Pose collect3Start = new Pose(-68.5, -60.5, Math.toRadians(-37.5));
            Pose collect3End = new Pose(-48.1, -75.8, Math.toRadians(-37.5));

            Pose finalShootPose = new Pose(-39.5, 5, Math.toRadians(-4));

...
@Autonomous(name = "Far Red - TEST", group = "z-Test")
public class FarRedAutoTest extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Pose collect1StartPose = new Pose(21, -14, Math.toRadians(-90));
            Pose collect1EndPose = new Pose(21, -35.5, Math.toRadians(-90));

            Pose collect2StartPose = new Pose(43, -14, Math.toRadians(-90));
            Pose collect2EndPose = new Pose(43, -35.5, Math.toRadians(-90));

            Pose collect3StartPose = new Pose(68, -14, Math.toRadians(-90));
            Pose collect3EndPose = new Pose(68, -35.5, Math.toRadians(-90));

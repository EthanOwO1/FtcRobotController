...
public class FarRedAuto extends OpMode {
    ...
    public static final double FLYWHEEL_P = 2.5;
    ...
    private double flywheelTargetVelocity = 1550;
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Pose shootPose = new Pose(3.22, 3.44, Math.toRadians(-31));
            Pose adjustedShootPose = new Pose(5, 3.44, Math.toRadians(-28));

            Pose collect1StartPose = new Pose(25, -14, Math.toRadians(-90));
            Pose collect1EndPose = new Pose(25, -37, Math.toRadians(-90));

            Pose collect2StartPose = new Pose(47, -14, Math.toRadians(-90));
            Pose collect2EndPose = new Pose(47, -37, Math.toRadians(-90));

            Pose collect3StartPose = new Pose(69, -14, Math.toRadians(-90));
            Pose collect3EndPose = new Pose(69, -37, Math.toRadians(-90));
